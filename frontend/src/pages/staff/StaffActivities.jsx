...
const StaffActivities = () => {
    ...
    useEffect(() => {
        const fetchActivities = async () => {
            try {
                const res = await axios.get('http://localhost:5000/api/activities?status=pending');
    ...
    const handleApprove = async (activityId) => {
        ...
        try {
            await axios.put(`http://localhost:5000/api/activities/${activityId}/review`, { status: 'approved', points: Number(inputPoints) });
