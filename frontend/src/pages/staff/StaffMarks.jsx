        ...
        const fetchAnalytics = async () => {
            try {
                ...
                const [marksRes, attRes] = await Promise.all([
                    axios.get(`http://localhost:5000/api/marks?subjectId=${selectedSub}&semester=${selectedSem}`, config),
                    axios.get(`http://localhost:5000/api/attendance?subjectId=${selectedSub}&semester=${selectedSem}`, config)
                ]);
