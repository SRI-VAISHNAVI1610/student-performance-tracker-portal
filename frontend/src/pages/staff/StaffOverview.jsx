        ...
        const fetchStudentDetails = async () => {
            ...
            try {
                ...
                const [mRes, aRes] = await Promise.all([
                    axios.get(`http://localhost:5000/api/marks?rollNumber=${selectedStudent}&semester=${selectedSem}`),
                    axios.get(`http://localhost:5000/api/attendance?rollNumber=${selectedStudent}&semester=${selectedSem}`)
                ]);
        ...
        const fetchGlobalStats = async () => {
            ...
            try {
                ...
                const [allMarksRes, allAttRes] = await Promise.all([
                    axios.get(`http://localhost:5000/api/marks?semester=${selectedSem}`, config),
                    axios.get(`http://localhost:5000/api/attendance?semester=${selectedSem}`, config)
                ]);
